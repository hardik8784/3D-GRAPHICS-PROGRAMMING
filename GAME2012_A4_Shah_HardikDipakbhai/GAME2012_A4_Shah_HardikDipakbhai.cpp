...
//***************************************************************************
// GAME2012_A3_ShahHardikDipakbhai.cpp by Hardik Dipakbhai Shah (C) 2020 All Rights Reserved.
//
...
PointLight pLight(glm::vec3(5.0f, 1.0f, -5.0f),	// Position.
...
void init(void)
{
	...
	unsigned char* image = stbi_load("wicked.jpg", &width, &height, &bitDepth, 0);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("GAME2012_A4_Shah_HardikDipakbhai");
