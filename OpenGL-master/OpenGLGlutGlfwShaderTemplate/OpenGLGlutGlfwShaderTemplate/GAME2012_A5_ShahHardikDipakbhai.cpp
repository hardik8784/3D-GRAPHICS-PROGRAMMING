//***************************************************************************
// GAME2012_A5_ShahHardikDipakbhai.cpp by Your Name (C) 2020 All Rights Reserved.
//
...
// Texture variables.
GLuint gridTexture, prismTexture, cubeTexture, coneTexture,insidecubeTexture;
...
void drawCube()
{
	...
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(5.0f, 2.0f, -5.0f));
...
void drawinsideCube()
{
	...
	transformObject(glm::vec3(0.2f, 0.2f, 0.2f), X_AXIS, rotAngle += ((float)45 / (float)1000 * deltaTime), glm::vec3(5.5f, 2.5f, -4.5f));
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("GAME2012_A5_ShahHardikDipakbhai");
